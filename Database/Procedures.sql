...
BEGIN
	...
	DELETE FROM BANGDIEM_MONHOC WHERE MAHS = @MAHS
...
BEGIN
	...
	BEGIN
		...
		INSERT INTO BANGDIEM_MONHOC VALUES (@TENLOP,TRIM(@TENMON), 'I', @STT, @MAHS, NULL, NULL, NULL)
		INSERT INTO BANGDIEM_MONHOC VALUES (@TENLOP, TRIM(@TENMON), 'II', @STT, @MAHS, NULL, NULL, NULL)
		FETCH NEXT FROM MAHS_CURSOR INTO @MAHS;
	END
	CLOSE MAHS_CURSOR;
